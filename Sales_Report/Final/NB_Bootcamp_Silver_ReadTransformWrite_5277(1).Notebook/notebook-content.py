...
bronze_tables = "abfss://BharatMart-Bootcamptraining@onelake.dfs.fabric.microsoft.com/LH_Bootcamp_Bronze.Lakehouse/Tables"
...
silver_customers.write.mode("overwrite").format("delta").saveAsTable("silver.silver_customers")
...
# write to silver lakehouse
silver_products.write.mode("overwrite").format("delta").saveAsTable("silver.silver_products")
...
# write to silver lakehouse
silver_stores.write.mode("overwrite").format("delta").saveAsTable("silver.silver_stores")
...
# write to silver lakehouse
silver_targets.write.mode("overwrite").format("delta").saveAsTable("silver.silver_targets")
...
# write to silver lakehouse
silver_sales.write.mode("overwrite").format("delta").saveAsTable("silver.silver_sales")
